...
<style>
    .pagination .page-link {
        ...
        border-color: #b11116; /* Warna border */
    }

    .pagination .page-link:hover {
        background-color: #9e0e12; /* Warna latar belakang saat di-hover */
        color: #fff; /* Warna teks saat di-hover */
        border-color: #9e0e12; /* Warna border saat di-hover */
    }

    .pagination .page-item.active .page-link {
        background-color: #b11116; /* Warna latar belakang item aktif */
        border-color: #b11116; /* Warna border item aktif */
    ...
    <div class="row mb-0">
        ...
        <div class="col-lg-3 col-xl-6">
            <ul class="list-inline mb-0 float-end">
                ...
                <li class="list-inline-item">
                    <button type="button" class="btn" style="background-color: #b11116; border-color: #b11116; color: #fff;" data-bs-toggle="modal" data-bs-target="#createEmployee">
       ...
       <div class="modal-content">
           <form action="{{ route('employees.store') }}" method="POST" enctype="multipart/form-data">
               ...
               <div class="modal-footer">
                   ...
                   <button type="submit" class="btn" style="background-color: #b11116; border-color: #b11116; color: #fff;">Save changes</button>
               </div>
           </form>
       </div>
   </div>
